...
// the vertex data (in positionBuffer) and color data per vertex (in
// colorBuffer)
...
void initialize() {
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER,
                 labhelper::array_length(indices) * sizeof(float), indices,
                 GL_STATIC_DRAW);

    // The loadShaderProgram and linkShaderProgam functions are defined in
    // glutil.cpp and do exactly what we did in lab1 but are hidden for
    // convenience
    shaderProgram = labhelper::loadShaderProgram(
        "../lab2-textures/simple.vert", "../lab2-textures/simple.frag");
