...
#define ENSURE_INITIALIZE_ONLY_ONCE()                                          \
    do {                                                                       \
        ...
        if (initialized) {                                                     \
            labhelper::fatal_error("initialize must only be called once when " \
...
///////////////////////////////////////////////////////////////////////////
void non_fatal_error(std::string errorString,
                     std::string title = std::string());

///////////////////////////////////////////////////////////////////////////
/// Initialize a window, an openGL context, and initiate async debug output.
///////////////////////////////////////////////////////////////////////////
SDL_Window *init_window_SDL(std::string caption, int width = 1280,
                            int height = 720);
...
///////////////////////////////////////////////////////////////////////////
/// Helper function used to get log info (such as errors) about a shader object
/// or shader program
///////////////////////////////////////////////////////////////////////////
std::string GetShaderInfoLog(GLuint obj);

///////////////////////////////////////////////////////////////////////////
/// Loads and compiles a fragment and vertex shader. Then creates a shader
/// program and attaches the shaders. Does NOT link the program, this is done
/// with  linkShaderProgram() The reason for this is that before linking we need
/// to bind attribute locations, using glBindAttribLocation and fragment data
/// lications, using glBindFragDataLocation.
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
/// Creates a GL buffer, uploads the given data to it, and attaches it to the
/// VAO. returns the handle of the GL buffer.
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
/// Creates a GL index buffer, uploads the given data to it, and attaches it ot
/// the VAO. returns the handle of the GL buffer.
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
/// Helper to set uniform variables in shaders, labeled SLOW because they find
/// the location from string each time. In OpenGL (and similarly in other APIs)
/// it is much more efficient (in terms of CPU time) to keep the uniform
